        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
            ...
            <div className="space-y-6">
                {metrics.map((m, i) => {
                    ...
                    if (displayPercentile > 90) rankLabel = 'Elite';
                    else if (displayPercentile > 75) rankLabel = 'High';
                    else if (displayPercentile < 25) rankLabel = 'Low';
                    else if (displayPercentile < 10) rankLabel = 'Poor';
