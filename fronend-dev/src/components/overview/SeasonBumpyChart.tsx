...
interface LogoTickProps {
    ...
    onToggleTeam: (abbr: string) => void;
    onHoverTeam: (abbr: string | null) => void;
    getTeamColor: (abbr: string) => string;
}
...
const LogoTick = ({
    ...
    return (
        <g
            onClick={() => teamAbbr && onToggleTeam(teamAbbr)}
            style={{ cursor: 'pointer' }}
            onMouseEnter={() => teamAbbr && onHoverTeam(teamAbbr)}
...
export const SeasonBumpyChart: React.FC = () => {
    ...
    const chartData = useMemo(() => {
        ...
        const dataByGw: Record<number, ChartDataPoint> = {};
